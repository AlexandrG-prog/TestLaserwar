...
{
    public class EmployeeEditManager : IWindowManager
    {
        ...
        public void CloseWindow(params object[] parameters)
        {
            ...
            _subdivisionComponent.EmployeeList =
                _employeeModel.GetEmployeeCollectionBySubdivision(_subdivisionComponent.Id);
        ...
        public void ShowWindow(params object[] parameters)
        {
            ...
            _employeeEditWindow.Title = "Edit employee";
